...
class Config():
    ...
    def expINFO(self, COM='abcd',targetNUM=40, blockNUM=6, srate=250, winLEN=1, paradigm='ssvep'):
        ...
        self.cue = np.tile(cueOrder, blockNUM)
        self.displayChar = [' %s' % self.char[i] for i in self.cue]
